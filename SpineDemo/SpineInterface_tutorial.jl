...
# the following callable subfield terms are from: ? Code_Construction
Code_Construction.name
Code_Construction.objects
Code_Construction.parameter_values

# some useful tips
first(Code_Construction_ConstructionYearClass.parameter_values)
...
U.classes
# array of objects affiliated to a parameter
U.classes[1]()
